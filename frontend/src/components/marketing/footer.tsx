    ...
    <footer className="bg-gray-800 text-white">
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-1">
            <div className="flex items-center gap-3">
              <GetMoreDinersLogo />
              <h2 className="text-white text-2xl font-bold">Get More Diners</h2>
            </div>
            <p className="mt-4 text-gray-400">The modern way to grow your restaurant.</p>
          </div>
          <div>
        ...
        <div className="mt-16 flex flex-col items-center border-t border-gray-700 pt-8 sm:flex-row sm:justify-between">
          <p className="text-gray-400">© {new Date().getFullYear()} Get More Diners. All rights reserved.</p>
